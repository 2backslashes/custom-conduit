...
public class ModParticles {
    ...
    public static final Supplier<ParticleType<SeekerParticles.SeekerParticleOptions>> SEEKER_PARTICLES = PARTICLE_TYPES.register("seeker_particles", () -> new SeekerParticles.SeekerParticleType(false));
